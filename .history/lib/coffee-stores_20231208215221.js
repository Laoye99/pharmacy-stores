...
const getUrlForPhaStores = (latLong, query, limit) => {
...
export const fetchCoffeeStores = async () => {
    const photos = await getListOfCoffeeStorePhotos();
      ...
      const response = await fetch(getUrlForCoffeeStores( '6.549210428174546%2C3.3716615277994073','pharmacy%20store', 6),options);
