...
import { fetchPharmacyStores } from "../../lib/coffee-stores";
...
export async function getStaticProps(staticProps) {
    ...
    return{
        props: {
            pharmacyStore: pharmacyStores.find((pharmacyStore) => {
...
const PharmacyStore = (props) => {
    ...
    const {name,  formatted_address, locality, imgUrl } = props.pharmacyStores;
